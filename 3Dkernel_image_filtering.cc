...
/*
To read and write an image in format .jpeg, libjpeg library is used.
Please be sure that you have it on your system installed.
Tip: you can install it on ubuntu by this command as root:
